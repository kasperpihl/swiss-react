...
addVariables({
  ...
  min1000: 'screen and (min-width: 1000px)',
  min1200: 'screen and (min-width: 1200px)',
  min1400: 'screen and (min-width: 1400px)',
  min1600: 'screen and (min-width: 1600px)',
  max400: 'screen and (max-width: 400px)',
  max600: 'screen and (max-width: 600px)',
  max800: 'screen and (max-width: 800px)',
